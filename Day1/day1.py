...
Find the top three Elves carrying the most Calories. How many Calories are those Elves carrying in total?'''
    def partTwo(calories):
        ...
        for elf in calories:
            ...
            if countCalories > first:
                temp = second
                second = first
                third = temp
                first = countCalories
            elif countCalories > second:
                third = second
                second = countCalories
            elif countCalories > third:
                third = countCalories
        
        return (first + second + third)
    print("The Elf carrying the most Calories is carring :" ,partOne(calories), "calories")
    print("The three Elves carrying the most calories are carrying:",partTwo(calories), "calories")
